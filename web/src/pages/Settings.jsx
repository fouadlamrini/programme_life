...
import { getMeApi, updateProfileApi } from '../services/authService'
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <section className="flex flex-col rounded-3xl border border-[#dfd2b7] bg-[#fffdf7] p-8 shadow-xl shadow-[#123d32]/10">
            ...
            <p className="mt-2 text-[#68776b]">
              لعملية منفصلة وآمنة، انتقل إلى صفحة تغيير كلمة المرور.
            </p>
            <Link
              className="mt-6 rounded-xl bg-[#b8731b] px-5 py-3.5 text-center font-semibold text-[#fffdf7] transition hover:bg-[#174d3d] focus:outline-none focus:ring-4 focus:ring-[#f7e4b4]"
